...
- [ ] **Web-Frontend:** создание небольшого пользовательского интерфейса (UI) для удобного поиска комиксов через браузер.
- [ ] **Kubernetes:** написание манифестов (Deployment, Service, Ingress и др.) и развертывание всей системы в кластере K8s.
