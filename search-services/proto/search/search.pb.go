...
const file_proto_search_search_proto_rawDesc = "" +
	...
	"\x05total\x18\x02 \x01(\x03R\x05total2\xbe\x01\n" +
	"\rSearchService\x126\n" +
	"\x04Ping\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\x127\n" +
	"\x06Search\x12\x15.search.SearchRequest\x1a\x16.search.SearchResponse\x12<\n" +
	"\vSearchIndex\x12\x15.search.SearchRequest\x1a\x16.search.SearchResponseB&Z$yadro.com/course/proto/search;searchb\x06proto3"
...
var file_proto_search_search_proto_depIdxs = []int32{
	1, // 0: search.SearchResponse.comics:type_name -> search.Comic
	3, // 1: search.SearchService.Ping:input_type -> google.protobuf.Empty
	0, // 2: search.SearchService.Search:input_type -> search.SearchRequest
	0, // 3: search.SearchService.SearchIndex:input_type -> search.SearchRequest
	3, // 4: search.SearchService.Ping:output_type -> google.protobuf.Empty
	2, // 5: search.SearchService.Search:output_type -> search.SearchResponse
	2, // 6: search.SearchService.SearchIndex:output_type -> search.SearchResponse
